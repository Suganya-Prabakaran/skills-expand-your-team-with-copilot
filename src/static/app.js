document.addEventListener("DOMContentLoaded", () => {
  ...
  function formatDifficultyLevel(difficultyLevel) {
    ...
    return `${difficultyLevel.charAt(0).toUpperCase()}${difficultyLevel.slice(
      1
    )}`;
  }
  ...
  function displayFilteredActivities() {
    ...
    Object.entries(allActivities).forEach(([name, details]) => {
      ...
      const searchableContent = [
        ...
        formatDifficultyLevel(activityDifficulty).toLowerCase(),
      ].join(" ");
  ...
  function renderActivityCard(name, details) {
    ...
    const formattedDifficultyLevel = formatDifficultyLevel(
    ...
    activityCard.innerHTML = `
      ...
      ${
        formattedDifficultyLevel
          ? `<p><strong>Difficulty:</strong> ${formattedDifficultyLevel}</p>`
          : ""
      }
      <p class="tooltip">
